...
if nargin < 1                      %   If there are no arguments given
    datain(1:5) = [3. 1.0 .5 1.0 .5];     %  Default waiting times for each frame
...
for n = 45:45:405 %generating distractor stim    
    ...
    Screen(d(n),'FillRect',[new_color;255,255,255;255,255,255]',[sRect(n,:);wRect(405,:);[25,20,45,40]]');%first square stim,second fixation, third sync square
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
