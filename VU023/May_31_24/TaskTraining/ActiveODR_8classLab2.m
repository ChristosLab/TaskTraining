...
% Balbir Singh 11/5/2019
%  Christos Constantinidis, Ph.D.
%  18-APR-2009
%  Implements an Oculomotor Delayed Response Task 
%  including a variable number of distractors after the cue
%  8 visual stimuli on a ring, of 12 degrees radius
%  For use in LAB #2
%  To run the script use: ODRdist(burst_amount,eye_window_size)
%  Last Modified:
%  24 JUN 2009 Changed number of blocks to 20
%              corrected display of second stimulus in operator screen
%              corrected delay period of 2nd/3rd stimulus
%              cleaned up unused variables
% make new ClassStructure, contain 16 classes, first 8 classes display
% white fixation point; the last 8 classes display blue fixation and
% require monkey saccade to the location of second stimulus
% these were done by using a variable 'ClassType' changing with currentClass
% 'ClassType =1 : white fixation; ClassType = 2 blue fixation.
% no luminace choice.
% Training version, switch between white blocks and blue blocks
% Statecode=6 changed  3/16/2011 xz
% add 'helplumcue' and 'helplumsecstim' for helping monkey in the reward screen
% xzhou 09-July-2011
%added FixationPointOff 03/10/15 CC
...
version     = 'ODRLab2 Jun-13-2019 CC'; 
datain(1:4) = [1.0 0.5 1.5 0.2];%  Default waiting times for each frame [1 0.5 1.5 0.2]
...
%load('C:\MATLAB6p5\work\ODRdist\class\classODR8stim.mat')
load('C:\Users\basingh\Documents\MATLAB\TaskTraining\class\classODR8stim_10deg.mat')  % place stimuli at 10 degrees eccentricity instead of 12
...
%%%%%%%%%%%%%%%%  Name Output File  %%%%%%%%%%%%%%%%%%%%%%%%%%%%
% OutputFileNames = fileoutdlg({'APM and Behavior output file',}, 'Output Files',[1 30],{'GRU00x_xx'});
...
aquisition_time = 1;            %  Give subject 1 second to move to fixation window
black = BlackIndex(0);
ReactionTime = 0;
subWrong = 1;
target_error = 0;
