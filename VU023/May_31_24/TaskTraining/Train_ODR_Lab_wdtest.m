function Train_ODR_Lab_wdtest(varargin)
%  Balbir Singh 10-31-19    %modify base on Balbir code
...
trialtype = datain(5);
switch trialtype                                                             %potentail problem
    case 1
        totalframes = 4;
    case 2
        totalframes = 4;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
RandYN = rand(totalblocks,8);                                               %potential problem
for n = 1:totalblocks
    Seq(n,:,1) = vstruct.angs2(randperm(8)); % sample display               %why third dimension
end
