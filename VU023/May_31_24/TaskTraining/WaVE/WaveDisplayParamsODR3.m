function [vstruct, Display] = WaveDisplayParamsODR3(vstruct, datain)
...
Display.StimSize       = [round(vstruct.pixdeg(1)*(70/100)*1) round(vstruct.pixdeg(2)*(70/100)*1)]; % Large stimulus size% consistent with prosaccade task
Display.FixSize        = [5 5];
