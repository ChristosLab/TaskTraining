...
version = 'Passive_garbor_geometry 29Nov22' ; % after code changes, change version
...
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStruct_gabor_geometry(Display, vstruct, GeneralVars.ClassStructure,MNM,1,num_stim);
WaitSecs(0.3);
