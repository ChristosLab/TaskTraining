...
%%  Version info
version = 'TrainODR_023_v0.12_11_30_21' ; % after code changes, change version
%   TrainODR_023_v0.11_11_13_21 to TrainODR_023_v0.12_11_30_21
%   - Added a second timestamping step in each iteration if the aquisition
%   time is not 0, timestampqueue indices now match the statecodes
%   - Extended eyedata logging until end of trial
%   - Corrected target frame to not contain the fixaton point (via
%     CreateWindowStructODR_023.m)
%   - Added variable "eye_display_queue" to store figure plotting
...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
datain(1:4) = [1 0.5 0.5 .2];    %  Default waiting times for each frame [fixation. cue delay1 sample delay2]
...
datain(9) = 3;                 %  Radius in degree of target window
datain(10) = 100;               %  Stimulus luminance as percentage (1 - 100) of color depth (typically 0 - 255)
datain(11) = 30;                %  Helper luminance as percentage (1 - 100) of color depth (typically 0 - 255)
numBurst = 1;
