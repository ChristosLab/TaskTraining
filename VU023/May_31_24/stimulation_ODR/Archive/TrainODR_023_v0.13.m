...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
datain(1:4) = [1 0.5 0.5 0.2];    %  Default waiting times for each frame [fixation. cue delay1 sample delay2]
...
datain(11) = 3;                %  Helper luminance as percentage (1 - 100) of color depth (typically 0 - 255)
numBurst = 1;
