...
%%  Version info
version = 'TrainODR_023_v0.13_11_30_21' ; % after code changes, change version
%   TrainODR_023_v0.12_11_30_21 to TrainODR_023_v0.13_11_30_21
...
for i = 1:n_class
    ...
    GeneralVars.ClassStructure(i).frame(1).lum = 1;
    GeneralVars.ClassStructure(i).frame(2).lum = 0;
    GeneralVars.ClassStructure(n_class + i) = GeneralVars.ClassStructure(i);
    GeneralVars.ClassStructure(n_class + i).frame(2).lum = 0.05;
    GeneralVars.ClassStructure(n_class + i).Notes = [num2str(current_degree), '_helper'];
end
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStructODRreminder_023(Display, vstruct, GeneralVars.ClassStructure);
