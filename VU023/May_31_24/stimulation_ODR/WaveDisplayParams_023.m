function [vstruct, Display] = WaveDisplayParams_023(vstruct, datain)
...
%   Voltage values recorded on NI DAQ in 23 on 11/12/21. - ZW
x_real_volt_range = [-4.5778, 4.4835];
y_real_volt_range = [-4.5919, 4.4890];
