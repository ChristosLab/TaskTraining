...
if nargin < 1                      %  If there are no arguments given
    datain(1:4) = [3 0 1.5 .5];    %  Default waiting times for each frame [fixation. cue delay1 sample delay2]
    datain(5) = 3;                 %  Trial type
    datain(6) = 3;                %  Number of blocks
    datain(7) = 0;                %  Stimulus eccentricity
    datain(8) = 3.2;                 %  Radius in degree of fi1xation window
    datain(9) = 6;                 %  Radius in degree of target window
    datain(10) = 100;              %  Luminance
    datasin = 'Yuki';    datain(11)=1.5;  %second delay
