%YOUR ASSIGNMENT IS TO MAKE THIS A FEATURE TASK,
%WHERE THE STIMULI APPEAR AT THE CENTER OF THE SCREEN
%WITH ONLY ONE FEATURE STIMULUS IN THE CUE
%AND ONE IN THE DELAY. 
...
if nargin < 1                      %   If there are no arguments given
    ...
    datain(8) = 300;               %  Radius in pixels of fixation window
