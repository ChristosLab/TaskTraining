...
% Modified 7/8/19 for Lab 3
[mousex,mousey] = getmouse;
warning off all

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if nargin < 1                      %  If there are no arguments given
    datain(1:4) = [0.2 0.1 0.1 0.2];    %  ***CHANGE THIS DURING TRAINING  Default waiting times for each frame [1 0.5 3 0.2]
    datain(5) = 4;                 %  Trial type
    datain(6) = 40;                %  Number of trials
    datain(7) = 3;             %  Stimulus eccentricity
    datain(8) = 5;     %  ***CHANGE THIS DURING TRAINING   Radius in degrees of Fixation Window
    datain(9) = 50;              %  Radius in degrees of target window
    datain(10) = 0;     %  ***CHANGE THIS DURING TRAINING Stimulus luminance (0-255) lEAVE AT 0, 255
    ...
    vstruct.siz = [70 55];        % screen size in cm  %[61 55]
...
[vstruct, Display] = WaveDisplayParamsODR3(vstruct, datain);
