...
if nargin < 1                      %  If there are no arguments given
    datain(1:4) = [1 0.5 1.5 0.5];    %  Default waiting times for each frame [fixation. cue delay1 sample delay2]
...
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStruct7(Display, vstruct, GeneralVars.ClassStructure,MNM,1);
WaitSecs(0.3);
