...
if nargin < 1                      %  If there are no arguments given
    ...
    datain(8) = 35;                 %  Radius in pixels of fixation window
    datain(9) = 50;                 %  Radius in pixels of target window
    ...
    switch_threshold = 3;
    burst_amount = 1;
    SwitchClass_Match    = [1 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2];
    SwitchClass_NonMatch = [3 4 3 4 3 4 3 4 3 4 3 4 3 4 3 4];
    SwitchClass_both     = [1:4,1:4,1:4,1:4,1:4,1:4,1:4,1:4];
...
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStruct5_color(Display, vstruct, GeneralVars.ClassStructure,MNM,numtargets,help_lum);
