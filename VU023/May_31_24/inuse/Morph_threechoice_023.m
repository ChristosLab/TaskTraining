function Morph_threechoice_023(varargin)
%  10/24/22 by WD
...
daqreset;
clc
load('C:\Users\CCLAB\Documents\MATLAB\inuse\CMT_threechoices_morphfourpair_30.mat');
...
if nargin < 1                      %  If there are no arguments given
   ...
   % datain(5) = 3;                 %  Trial type, not used here
    ...
    datain(9) = 60;                 %  Radius in pixels of target window
    ...
    switch_threshold = 3;
    burst_amount = 2;
    Class_touse      = [1:30];   %one axis, all morphs
...
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStruct_threechoices_morphone4pair(Display, vstruct, GeneralVars.ClassStructure,numtargets,dist_lum);
