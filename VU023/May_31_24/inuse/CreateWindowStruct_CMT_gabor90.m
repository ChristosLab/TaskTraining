function [window, f, r,WindowStructure, AllCoordinates] = CreateWindowStruct_CMT(Display, vstruct, ClassStructure,numtargets,dist_lum)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Changes %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                                               %Pixels
Stimulus(1).Feature = imread('0.BMP');    % 4813
...
Stimulus(3).Feature = imread('45.BMP');         % 4810
Stimulus(4).Feature = imread('67.5.BMP');    % 4880
Stimulus(5).Feature = imread('90.BMP');      % 4818
Stimulus(6).Feature = imread('Plus.BMP');    % 4900
Stimulus(7).Feature = imread('135.BMP');  % 4900
Stimulus(8).Feature = imread('157.5.BMP');         % 4808
