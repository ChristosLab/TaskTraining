...
clearvars;  % delete all variables5500000
WaveInitDaq
%PsychDefaultSetup(2);   %potential source of problem set up color range to [0,1], it exec1utes Screen(5ColorRange5, window, 1, [], 1);
centerkey=KbName('5');
leftkey=KbName('4');
rightkey=KbName('6');
upkey=KbName('8');
