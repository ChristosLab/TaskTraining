...
if nargin < 1                      %  If there are no arguments given
   ...
   % datain(5) = 3;                 %  Trial type, not used here
    ...
    switch_threshold = 3;
    burst_amount = 2;
  Class_touse      = [1:20];   %one axis, all morphs
    %Class_touse     = [1:4,9:12,17:20]; %one axis. three morph levles
    %Class_touse     = [1:4,9:12,17:20,21:24,29:32,37:40,41:44,49:52,57:60,61:64,69:72,77:80];% all axis 3 morphs per axis
    %Class_touse     = [1:80];   %all axis, all morphs
