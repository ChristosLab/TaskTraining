...
daqreset;
clc
load('C:\Users\CCLAB\Documents\MATLAB\inuse\Class9.mat'); %this file for phase 3 and 4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%sc%%%%%%%%%%%%%%%%%%
if nargin < 1                      %  If there are no arguments given
    ...
    datain(8) = 25;                 %  Radius in pixels of fixation window
...
go = 1;
filenamecheck = ['C:\Users\CCLAB\Documents\MATLAB\Behavioral_Data\' datasin '.mat'];
...
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStruct5_old(Display, vstruct, GeneralVars.ClassStructure,MNM,numtargets,1);
