...
daqreset;
clc
load('C:\Users\CCLAB\Documents\MATLAB\inuse\CMT_classes.mat'); %this file for phase 3 and 4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%sc%%%%%%%%%%%%%%%%%%
...
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStruct_CMT(Display, vstruct, GeneralVars.ClassStructure,numtargets);
