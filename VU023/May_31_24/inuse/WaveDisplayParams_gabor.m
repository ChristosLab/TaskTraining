function [vstruct, Display] = WaveDisplayParams_old(vstruct, datain)
...
Display.StimSize = [round(vstruct.pixdeg(1)*(100/100)*3) round(vstruct.pixdeg(2)*(100/100)*3)];   % (100/70)               % size of the stimuli in pixels
Display.FixSize = [3 3];
