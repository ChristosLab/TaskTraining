function gabor_ChooseMatch_023(varargin)
%  10/24/22 by WD
...
daqreset;
clc
load('C:\Users\CCLAB\Documents\MATLAB\inuse\CMT_classes_gabor90.mat'); %this file for phase 3 and 4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%sc%%%%%%%%%%%%%%%%%%
if nargin < 1                      %  If there are no arguments given
    datain(1:3) = [1 .5 .5];    %  Default waiting times for each frame
   % datain(1:3) = [1 .5 0.25];
...
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStruct_CMT_gabor90(Display, vstruct, GeneralVars.ClassStructure,numtargets,dist_lum);
