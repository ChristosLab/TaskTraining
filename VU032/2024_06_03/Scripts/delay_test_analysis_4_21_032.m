%% run2
oe_folder = 'Z:\Users\wangz56\delay_test_32\run2';
mat_file = 'C:\Users\cclab\Documents\MATLAB\beh\delay_test_32_run_2.mat';
title_str = 'WH032 display delay test - Intel GPU port';
plot_delay_test(oe_folder, mat_file, title_str);
%% run4
oe_folder = 'Z:\Users\wangz56\delay_test_32\run4';
mat_file = 'C:\Users\cclab\Documents\MATLAB\beh\delay_test_32_run_4.mat';
title_str = 'WH032 display delay test - Intel GPU port';
plot_delay_test(oe_folder, mat_file, title_str);
%% run5
oe_folder = 'Z:\Users\wangz56\delay_test_32\run5';
mat_file = 'C:\Users\cclab\Documents\MATLAB\beh\delay_test_32_run_5.mat';
title_str = 'WH032 display delay test - NVIDIA GPU port';
plot_delay_test(oe_folder, mat_file, title_str);
%% run6
oe_folder = 'Z:\Users\wangz56\delay_test_32\run6';
mat_file = 'C:\Users\cclab\Documents\MATLAB\beh\delay_test_32_run_6.mat';
title_str = 'WH032 display delay test - NVIDIA GPU port';
plot_delay_test(oe_folder, mat_file, title_str);
%% run7
oe_folder = 'Z:\Users\wangz56\delay_test_32\run7';
mat_file = 'C:\Users\cclab\Documents\MATLAB\beh\delay_test_32_run_7.mat';
title_str = 'WH032 display delay test - NVIDIA GPU port';
plot_delay_test(oe_folder, mat_file, title_str);
%% run8
oe_folder = 'Z:\Users\wangz56\delay_test_32\run8';
mat_file = 'C:\Users\cclab\Documents\MATLAB\beh\delay_test_32_run_8.mat';
title_str = 'WH032 display delay test - NVIDIA GPU port';
plot_delay_test(oe_folder, mat_file, title_str);
%%
function plot_delay_test(oe_folder, mat_file, title_str)
