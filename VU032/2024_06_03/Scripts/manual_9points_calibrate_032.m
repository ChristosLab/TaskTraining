%   5 points for ISCAN ca50libration 6/10/20 Wenhao
%   changed params for VU WHAF room 032 -- J Zhu 20220713
%   Check display params before use
Screen('Preference', 'VisualDebugLevel', 3);
sca; % Execute Screen(5CloseAll0) closs all psychtoolbox win50dows
close all;  %close all figure windows5
clearvars;  % delete all variables
WaveInitDaq

%PsychDefaultSetup(2);   %potential source of problem set
% up color range to [0,1], it exec1utes Screen(5ColorRange0, window, 1, [], 1);
centerkey=KbName('5');
