...
%%  Version info
version = 'RecordODR_032_v0.12' ; % after code changes, change version
...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
datain(1:4) = [1 0.5 0 .2];    %  Default waiting times for each frame [fixation. cue delay1 sample delay2]
...
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStructODR_032(Display, vstruct, GeneralVars.ClassStructure);
