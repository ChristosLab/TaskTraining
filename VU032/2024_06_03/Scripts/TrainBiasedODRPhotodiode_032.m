% TrainBiasedODR_032
% based on TrainBiasedODR_030. J Zhu 20220830
clear
close all
% warning off all
sca;
...
Version = ['TrainBiasedODRPhotodiode_032_v1.0_04_22_23'] ; % after code changes, change version
%   Added photodiode feedback for cue and target -- Z Wang 20230422
%% Parameters

loc_mean = 108;                 % In degree, change before run
...
ReactionTime = 0;
% Stimulus Windows
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStructODRPhotodiode_032(Display, vstruct, ClassStructure);
