function [window, f, r, WindowStructure, AllCoordinates] = CreateWindowStructODRPhotodiode_032(Display, vstruct, ClassStructure)
% Adapted from CreateWindowStructODR_030 for use in VU WHAF room 032. JZ 20220726
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for m  = 1:length(ClassStructures)
    for n = 1:length(ClassStructures(m).frame)
        ...
        % Photodiode on for both cue and target frames
