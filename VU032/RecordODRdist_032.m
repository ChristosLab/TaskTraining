% RecordODRdist_032
% based on TrainODRDist_032. JZ 20220731
clear
close all
% warning off all
sca;
...
Version = 'RecordODRdist_032_v0.10_2022_07_31' ; % after code changes, change version
%   Adapted for VU WHAF room 032. J Zhu 20220726
%% Parameters
...
[ClassStructure] = CreateClassStructure_ODR_dist_032(stim_radius, cue_loc);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Visual settings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
