...
%%  Version info
version = 'RecordODR_Opto_030_v0.1' ; % after code changes, change version
%   New WaveInitDaq
...
ao_mod_params.freq = 50; % Modulation frequncy (Hz)
ao_mod_params.amp = 1; % Modulation voltage (V, 0 to max)
ao_mod_params.T = 1; % Laser on duration (second)
