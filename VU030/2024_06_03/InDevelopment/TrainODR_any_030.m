...
%%  Version info
version = 'TrainODR_any_030_v0.1_2023_07_31' ; % after code changes, change version
...
GeneralVars.ClassStructure = GeneralVars.ClassStructure(target_class);
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
datain(1:4) = [1 0.5 3.0 .3];    %  Default waiting times for each frame [fixation. cue delay1 sample delay2]
datain(5) = 3;                 %  Trial type
datain(6) = 30;                %  Number of blocks
...
datain(11) = 4;                %  Helper luminance as percentage (1 - 100) of color depth (typically 0 - 255)
numBurst = 3;
