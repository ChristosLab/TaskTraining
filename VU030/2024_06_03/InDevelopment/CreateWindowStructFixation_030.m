function [window, f, r, WindowStructure, AllCoordinates] = CreateWindowStructFixation_030(Display, vstruct, ClassStructure)
...
Screen(f,'FillRect',WhiteIndex(0),[0 0 60 50]);
%   sync window
