...
Version = 'BiasedODRTestDelay_030_v0.1_20230420' ; % after code changes, change version

%% Parameters

loc_mean = 150;                 % In degree, change before run
...
intertrial_interval_correct = 1;
intertrial_interval_error = 1;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
