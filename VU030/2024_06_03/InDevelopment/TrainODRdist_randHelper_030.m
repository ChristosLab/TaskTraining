% TrainODRDist_randHelper_030
% based on TrainODRDist_030. JZ 20220831
% add an option to add target helper at random trials for training PIC
clear
close all
% warning off all
sca;
...
Version = 'TrainODRDist_randHelper_030_v0.11_2022_08_31' ; % after code changes, change version
%   From TrainODR add an option to add target helper at random trials for training PIC
%% Parameters
...
datain(9) = 3.5;                 % Radius in degree of target window
...
datain(12) = 1.1;                % Helper luminance as percentage (1 - 100) of color depth (typically 0 - 255)
num_burst = 2;
fix_aquisition = 1;
...
% Stimulus Windows
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStructODR_030_randHelper(Display, vstruct, ClassStructure);
