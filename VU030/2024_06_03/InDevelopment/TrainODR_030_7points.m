...
for i = 1:n_class
    if i~=4
        ...
        GeneralVars.ClassStructure(class).frame(1).stim.end = stim_radius.*[cos(current_degree/180*pi), sin(current_degree/180*pi)];
        GeneralVars.ClassStructure(class).frame(2).stim.end = stim_radius.*[cos(current_degree/180*pi), sin(current_degree/180*pi)];
        GeneralVars.ClassStructure(class).Notes = num2str(current_degree);
        class = class + 1;
    end
end
