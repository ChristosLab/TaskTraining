% Edited 2023-5-17
% Assigned Port0/Line7 to be used for continuous sampling of photodiode
% output
% Added ao0 for modulating the laser.
warning('off', 'daq:Session:queuedDataHasBeenDeleted');
...
Ach(3).Range = [-5.0 5.0];
Dch_in = addDigitalChannel(ai, 'Dev1', 'Port0/Line7', 'InputOnly');
...
Dch=addDigitalChannel(DO,'Dev1',{'Port0/Line0:6', 'Port1/Line0'},'OutputOnly');


AO = daq.createSession('ni');
AchOut = addAnalogOutputChannel(AO, 'Dev1', [0, 1], 'Voltage');
AO.IsContinuous = false;
AO.Rate=1000;
%%
