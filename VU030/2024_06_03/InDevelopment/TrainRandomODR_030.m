% TrainRandomODR_030
% based on TrainRandomODR_032. J Zhu 20230504
...
%%  Version info
Version = 'TrainRandomODR_030_v0.11_05_04_2023' ; % after code changes, change version

%% Parameters
datain(1:4) = [1, 0.5, 2.0, 0.2];  % Default waiting times for each frame [fixation, cue, delay, saccade]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
n_class = 120; % 360/3
stim_radius = datain(7); % Stimulus eccentricity
