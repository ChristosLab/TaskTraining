...
%%  Version info
Version = 'RecordBiasedODR_029_v0.21_05142023' ; % after code changes, change version
%   Added AllData.parameter.script variable to save the current script as
%   Addapted from room 29 2023_05_14 ZW
%% Parameters


loc_mean = 105;                 % In degree, change before run
...
[ClassStructure, p, alpha, AllList] = CreateClassStructure_ODR_vm_029(stim_radius, n_class, loc, kappa, w);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Visual settings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% send_network_event_029(save_name);
WaitSecs(2);
...
% send_network_event_029([save_name, '_end_of_session']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
