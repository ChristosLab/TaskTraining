...
%%  Version info
Version = ['TrainRandomODR_029_v0.11_05_15_2023'] ; % after code changes, change version
...
datain(10) = 3;               % Stimulus luminance as percentage (1 - 100) of color depth (typically 0 - 255)
datain(11) = 1.5;                % Helper luminance as percentage (1 - 100) of color depth (typically 0 - 255)
num_burst = 2;
fix_aquisition = 1;
