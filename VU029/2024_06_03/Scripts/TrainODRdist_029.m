% TrainODRDist_029
% based on TrainODRDist_030. JZ 20220726
clear
close all
% warning off all
sca;
...
Version = 'TrainODRDist_029_v0.11_2023_05_15' ; % after code changes, change version
%   Adapted for VU WHAF room 029. Z Wang
%% Parameters
...
% to train location 9 only
% ClassStructure=ClassStructure(1:5);
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Visual settings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
