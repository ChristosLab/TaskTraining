...
%%  Version info
version = 'eight_point_calib_029_v0.1_20230515' ; % after code changes, change version
...
%   Visual Settings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
intertrial_interval_correct = 5;
intertrial_interval_error   = 5;
...
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStructCalib_029(Display, vstruct, GeneralVars.ClassStructure);
