function [vstruct, Display] = WaveDisplayParams_032(vstruct, datain)
...
%   Voltage values recorded on NI DAQ in 32 on 07/06/22. - ZW
x_real_volt_range = [-4.5769, 4.4757];
y_real_volt_range = [-4.5817, 4.4676];
