function  [ClassStructure, p, alpha, AllList]= CreateClassStructure_ODR_vm_029(d, nsample, thetahat, kappa, w) %,Nclass,StartAngle,angleStep)
% clear
if nargin < 4
    w=[0.5 0.5];
end
...
alpha = alpha(1:end-1);
[p, alpha] = circ_vmpdf_032(alpha, thetahat, kappa, w);
