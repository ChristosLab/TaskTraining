% TrainBiasedODR_029
% based on TrainBiasedODR_032. Z Wang 05152023
clear
close all
% warning off all
sca;
...
Version = ['TrainBiasedODR_029_v0.11_05_15_23'] ; % after code changes, change version
%% Parameters

loc_mean = 7;                 % In degree, change before run
