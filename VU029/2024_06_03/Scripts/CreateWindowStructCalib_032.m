function [window, f, r,WindowStructure, AllCoordinates] = CreateWindowStructCalib_032(Display, vstruct, ClassStructure)
% Adapted from CreateWindowStructCalib_030 for use in VU WHAF room 032. JZ 20220726
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for m = 1:length(ClassStructure)
    for n = 1:numel(ClassStructure(m).frame)
        ...
        ClassStructures(m).frame(n).stim(1).wRect   = [tCenter(1) - Display.FixSize(1), tCenter(2) - Display.FixSize(2), ...
            tCenter(1) + Display.FixSize(1), tCenter(2) + Display.FixSize(2)];
