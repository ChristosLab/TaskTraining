% TrainODRDist_diag_029
% based on TrainODRDist_029. dist on only diag locations to the cue
clear
close all
% warning off all
sca;
...
Version = 'TrainODRDist_029_v0.11_2023_08_03' ; % after code changes, change version
%   New CreateClassStructure_ODR_dist_diag_029 called
%% Parameters
...
datain(12) = 1;                % Helper luminance as percentage (1 - 100) of color depth (typically 0 - 255)
num_burst = 2;
fix_aquisition = 1;
...
[ClassStructure] = CreateClassStructure_ODR_dist_diag_029(stim_radius, cue_loc);
% [ClassStructure] = CreateClassStructure_ODR_dist_029(stim_radius, cue_loc);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Visual settings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[vstruct, Display] = WaveDisplayParams_029(vstruct, datain);
...
% Stimulus Windows
[window, f, r, WindowStructure, AllCoordinates] = CreateWindowStructODR_029(Display, vstruct, ClassStructure);
