...
Version = ['TrainBiasedODR_032_v0.11_08_30_22'] ; % after code changes, change version
%   Adapted for VU WHAF room 032 -- J Zhu 20220830
%% Parameters

loc_mean = 170;                 % In degree, change before run
