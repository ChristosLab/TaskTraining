function [window, f, r, WindowStructure, AllCoordinates] = CreateWindowStructODR_029(Display, vstruct, ClassStructure)
%Added photodiode event to target frame. ZW 05152023
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for m  = 1:length(ClassStructures)
    for n = 1:length(ClassStructures(m).frame)
        ...
        % Photodiode ON for Cue frame and target frame
