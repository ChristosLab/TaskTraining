...
% use protocol named "AntiSaccadeCircle" mat file
...
if nargin < 1                      %  If there are no arguments given
    ...
    datain(8) = 3.6;               %  Radius in pixels of fixation window
    datain(9) = 6;                 %  Radius in pixels of target window
    datain(10) = 255;              %  Luminance
    gray2 = 0;
%     datasin = 'temp';
%     MNM = 'Match';
   
    burst_amount = 3;
    aquisition_time = 2;          % fixation aquisition time
    Target_aquisition_time = 0.6;          % target aquisition time
...
version = 'AntiSaccaderain June-15-2011' ; % after code changes, change version
rand('state',sum(100*clock));
screen('closeall');daqreset % clear screen and NiDaq card from previous use
OutputFileNames = fileoutdlg({'APM and Behavior output file',}, 'Output Files',[1 30],{'Elv000_000'}); % XQ
